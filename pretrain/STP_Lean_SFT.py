...
input_p = '/data3/ftpdata/kmwang5/Lean-dataset/Lean-4/0_ori/STP_Lean_SFT/folded_data_all.json'
output_p = '/data3/ftpdata/kmwang5/Lean-dataset/Lean-4/1_pretrain/STP_Lean_SFT/STP_Lean_SFT.json'
datasource = 'STP_Lean_SFT'
