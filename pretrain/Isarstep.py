...
read_file_path = '/data3/ftpdata/kmwang5/Lean-dataset/Isabelle/0_ori/IsarStep/train.tgt'
save_file_path  = '/data3/ftpdata/kmwang5/Lean-dataset/Isabelle/1_pretrain/Isarstep/Isarstep.json'
