...
output_p = '/data3/ftpdata/kmwang5/Lean-dataset/Lean-3/1_pretrain/MUSTARDSauce/MUSTARDSauce-NLS-NLP.json'
...
def main():
    ...
    for data in tqdm(indata):
        ...
        context = add_ret(inputtext) + add_ret(data['informal_proof'])
