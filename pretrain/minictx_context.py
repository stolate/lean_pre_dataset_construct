...
input_p = '/data6/ftpdata/yilei4/math/data/train/org/miniCTX/miniCTX-instruct-context'
output_p = '/data6/ftpdata/yilei4/math/data/train/pretrain_format/miniCTX_instruct_context.json'
dataset = 'miniCTX'   #sys.argv[3]
prompt_p = '/data6/ftpdata/yilei4/math/data/train/instructions/minictx_context.json'

st_instr = [
    '{INSTRUCTION}\nThe given Lean4 state is\n{STATE}\nContext is\n{CONTEXT}',
    '{INSTRUCTION}\nThe current proof state is as below.\n{STATE}\nContext is as below.\n{CONTEXT}',
    'Below is the given current state of a Lean4 proof.\n{STATE}\n{INSTRUCTION}\nContext is as follows.\n{CONTEXT}',
    'The current proof state is\n{STATE}\n{INSTRUCTION}\nContext is \n{CONTEXT}',
    '{STATE}\nAbove is a Lean4 proof state and below is the context.\n{CONTEXT}\n{INSTRUCTION}\n',
    '{INSTRUCTION}\nCurrent proof state is as follows.\n{STATE}\nContext is as follows.\n{CONTEXT}',
    '{INSTRUCTION}\nFollowing is the proof state.\n{STATE}\nContext is below.\n{CONTEXT}',
    ]
...
def main():
    ...
    for data in tqdm(indata):
        ...
        text_instruct = random.choice(st_instr).format(INSTRUCTION=instruct, STATE=state, CONTEXT=context)
        #print(prompt)
        text_response = data['completion'].replace('[/TAC]', '')
        #print(text_response)
        #raise
        datasource = dataset + '_' + 'instruct_context' #data['prompt_name']
