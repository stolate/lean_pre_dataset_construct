...
output_p = '/data3/ftpdata/kmwang5/Lean-dataset/Lean-4/1_pretrain/lean-nl/lean-nl-NLS-FLS.json'
back_p = '/data3/ftpdata/kmwang5/Lean-dataset/Lean-4/1_pretrain/lean-nl/backtrans_lean-nl-NLS-FLS.json'
datasource = 'lean-nl'
...
def main():
    ...
    for data in tqdm(indata):
        ...
        data['formal_statement'] = data['formal_statement'].replace(':=  by', ':= by')
