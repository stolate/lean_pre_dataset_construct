...
input_p = '/data6/ftpdata/yilei4/math/data/train/org/miniCTX/miniCTX-instruct-st'
output_p = '/data6/ftpdata/yilei4/math/data/train/pretrain_format/miniCTX_instruct_st.json'
dataset = 'miniCTX'   #sys.argv[3]
prompt_p = '/data6/ftpdata/yilei4/math/data/train/instructions/minictx_st.json'
...
st_instr = [
    ...
    '{STATE}\nAbove is a Lean4 proof state.\n{INSTRUCTION}\n',
    '{INSTRUCTION}\nCurrent proof state is as following.\n{STATE}\n',
...
def main():
    ...
    for data in tqdm(indata):
        ...
        text_instruct = random.choice(st_instr).format(INSTRUCTION=instruct, STATE=state)       
        #print(prompt)
        text_response = data['completion'].replace('[/TAC]', '')
        #print(text_response)
        #raise
        datasource = dataset + '_' + 'instruct_st' #data['prompt_name']
